...
//                \\Pos: {d:.1} {d:.1} {d:1}
//                \\Index: {}
//                    , .{ent.sprite.pos.x, ent.sprite.pos.y, ent.sprite.pos.z, ent.world_index});
//
...
pub fn engineDesc() app.Desc {
    return .{
        .init_cb = Platform.init,
        .frame_cb = Platform.frame,
        .event_cb = Platform.input,
        .cleanup_cb = Platform.deinit,
        .width = 1200,
        .height = 800,
        .window_title = "HELLO",
    };
...
const Platform = @import("app/sokol.zig").App;
...
const RenderDriver = @import("render.zig");
const AudioDriver = @import("audio.zig");
const LogDriver = @import("log.zig");
const HotReloadDriver = @import("hot_reload.zig");
